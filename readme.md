...
### Title + tagline
`Xiv2Pub` — Convert arXiv LaTeX papers to readable EPUBs
...
### What you get section (bullet list)
- EPUB3 optimised for Apple Books
- MathML equations (native rendering, not images)
- All figures embedded
- Full bibliography with clickable citation links
- Table of contents spanning sections and appendices
- Latin Modern fonts bundled (matches LaTeX PDF typography)
 
### How it works section (brief prose + numbered pipeline)
